...
public class UsersDAO extends AbstractDao<Users, Integer> implements UserDetailsService {
	...
	public Boolean getIsAdmin() {
		Funcionarios funcionario = getUsuarioLogado();
		TypedQuery<Boolean> query = entityManager.createQuery("SELECT u.isAdmin FROM Users u where u.id = " + funcionario.getId(),
				Boolean.class);
		return query.getSingleResult();
	}

	public Funcionarios findByFuncionarioUserName(String username) {
		List<Funcionarios> lista = funcionariodao
